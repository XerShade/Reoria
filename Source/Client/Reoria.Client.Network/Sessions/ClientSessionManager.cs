...
{
    private ClientSessionData? currentSession;

    /// <summary>
    /// Gets the current session data.
    /// </summary>
    public ClientSessionData? CurrentSession => currentSession;
    ...
    public ClientSessionData CreateSession(Guid sessionId)
    {
        ...
        currentSession = new ClientSessionData(sessionId);
    ...
    public void InitializeSession(Guid playerId, string username, IEnumerable<string> roles, IEnumerable<string> permissions)
    {
        ...
        currentSession.InitializePlayer(playerId, username, roles, permissions);
    }
    ...
    public ClientSessionData? GetCurrentSession()
    {
        return currentSession;
    }
    ...
    {
        return currentSession?.AddOwnedEntity(entityId) ?? false;
    }
    ...
    {
        return currentSession?.RemoveOwnedEntity(entityId) ?? false;
    }
    ...
    {
        return currentSession?.OwnsEntity(entityId) ?? false;
    }
    ...
    public IReadOnlyCollection<Guid> GetOwnedEntities()
    {
        return currentSession?.OwnedEntities ?? Array.Empty<Guid>();
    }
    ...
    {
        currentSession?.ClearOwnedEntities();
    }
