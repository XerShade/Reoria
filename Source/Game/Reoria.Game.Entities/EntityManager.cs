...
/// The EntityManager integrates with the game loop through phase participant interfaces to provide
...
/// </remarks>
public class EntityManager : IEntityManager, IDisposable, IGameVariableUpdate
#if !SERVER
    , IGameRender
#endif
{
    ...
    /// </summary>
    /// <remarks>
    /// This property implements IPhaseParticipant.Platform requirement.
    /// Returns Platform.All indicating this manager works on all platforms
    /// since ECS operations are platform-agnostic.
    /// </remarks>
    ...
    /// <remarks>
    /// This method implements the IGameRender interface to integrate
